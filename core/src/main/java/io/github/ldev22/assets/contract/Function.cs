...
public class Function
{
    ...
    private readonly IContractUpdateService _caseDetailsService;
    ...
    public Function()
    {
        ...
        _caseDetailsService = new ContractUpdateService(connectionFactory, _dbConfig);
        _requestValidator = new RequestValidator();

        LambdaLogger.Log("INFO: Function constructor completed.");
    }

    public Function(IContractUpdateService caseDetailsService, IRequestValidator requestValidator, DatabaseConfig dbConfig)
    {
